      ...
      <div className="page-container">
        ...
        <div className="grid-auto stagger-children">
          ...
          {filtered.map((member, i) => {
            ...
            const color = member.avatar_color || colorsList[i % colorsList.length];
...
<AnimatePresence>
  {drawer && (() => {
    ...
    return (
      ...
      {/* ADD MODAL */}
      <Modal isOpen={showAdd} onClose={closeAddModal} title="Add Member">
        <input name="name" value={form.name} onChange={handleFormChange} className="input" placeholder="Name" />
        <input name="role" value={form.role} onChange={handleFormChange} className="input" placeholder="Role" />
        <input name="email" value={form.email} onChange={handleFormChange} className="input" placeholder="Email" />
        <input name="qualification" value={form.qualification} onChange={handleFormChange} className="input" placeholder="Qualification" />
        <input name="experience" value={form.experience} onChange={handleFormChange} className="input" placeholder="Experience" />
        <input name="skills" value={form.skills} onChange={handleFormChange} className="input" placeholder="Skills" />

        <button className="btn btn-primary" onClick={handleAdd}>Add</button>
      </Modal>

      {/* EDIT MODAL */}
      <Modal isOpen={showEdit} onClose={closeEditModal} title="Edit Member">
        <input name="name" value={form.name} onChange={handleFormChange} className="input" />
        <input name="role" value={form.role} onChange={handleFormChange} className="input" />
        <input name="email" value={form.email} onChange={handleFormChange} className="input" />
        <input name="qualification" value={form.qualification} onChange={handleFormChange} className="input" />
        <input name="experience" value={form.experience} onChange={handleFormChange} className="input" />
        <input name="skills" value={form.skills} onChange={handleFormChange} className="input" />
